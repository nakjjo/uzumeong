...
function init3DUniverse() {
    ...
    const mainStars = [
        ...
        { name: '플레이아데스', x: -2200, y: -500, z: -1800, color: '#add8e6', info: '수백 개의 어린 별들이 모여 있는 성단입니다. "좀생이별"이라 불려요.' },
        { name: '안드로메다 은하', x: 2500, y: -1000, z: -4000, color: '#ffccff', info: '우리 은하와 가장 가까운 거대 나선 은하입니다.' },
        { name: '오리온 성운', x: 450, y: 700, z: -1600, color: '#ff99cc', info: '별들이 새로 태어나는 거대한 가스 구름입니다.' },
        { name: '알비레오', x: 2100, y: 500, z: -1900, color: '#ffd700', info: '가장 아름다운 이중성 중 하나입니다.' },
        { name: '게 성운', x: -800, y: -1800, z: -3000, color: '#00ced1', info: '초신성 폭발의 잔해입니다.' },
        { name: '말머리 성운', x: 550, y: 850, z: -1700, color: '#4b0082', info: '말 머리를 닮은 암흑 성운입니다.' },
        { name: '고리 성운', x: 1700, y: -1200, z: -2800, color: '#7fffd4', info: '우주의 눈동자처럼 보이는 성운입니다.' },
        { name: '장미 성운', x: -1200, y: 1800, z: -2300, color: '#ff1493', info: '붉은 장미꽃을 닮은 성운입니다.' }
    ];
